...
import { buildRouter } from './http.js';
...
function main(): void {
  ...
  // REST API (phone/operator/prompter). Image generation goes straight to the
  // Runware API from the server — there is no local worker/Forge stack.
  app.use(buildRouter());
